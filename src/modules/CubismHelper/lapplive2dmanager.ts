...
export class LAppLive2DManager {
  ...
  public onTap(x: number, y: number): void {
    ...
    // }
    // for (let i = 0; i < this._models.getSize(); i++) {
    //   console.log(this._models.at(i)._expressions._keyValues);
  ...
  public onUpdate(): void {
    ...
    projection.scaleRelative(LAppDefine.scale, LAppDefine.scale);
    projection.translateRelative(0, LAppDefine.translateY);
